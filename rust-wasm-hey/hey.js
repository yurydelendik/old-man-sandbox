...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'hey.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'hey.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'hey.temp.asm.js';
...
STATICTOP = STATIC_BASE + 15376;
/* global initializers */  __ATINIT__.push();


memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "hey.html.mem" : null;




var STATIC_BUMP = 15376;
